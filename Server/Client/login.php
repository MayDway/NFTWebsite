        ...
        <section class="sample-text-area">
            <div class="container box_1170">
                <h3 class="text-heading">Welcome to NFT</h3>
                  <p> Haven't created an account yet? <a href="creatacc.php" class="genric-btn primary-border radius">Sign Up</a></p><br>
              <form action="../login.php" method="post">
                        ...
                        <button type="submit" name="login" class="button button-contactForm btn_1">Login </button>
                     </div>
                        </form>
            </div>
        </section>
