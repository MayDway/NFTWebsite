    ...
    <div class="element_page black">
        ...
        <section class="sample-text-area">
            <div class="container box_1170">
                <h3 class="text-heading">Online service</h3>
                  <p> Dear NFT member users Hello, online customer service is pleased to solve your problems, about account registration, real name authentication, funds transfer, membership upgrade, withdrawal and other issues, online customer service to answer your questions.</p><br>
                  <form class="form-contact comment_form" action="#" id="commentForm">
                     <div class="row">
                        <div class="col-12">
                           <div class="form-group">
                              <textarea class="form-control w-100" name="comment" id="comment" cols="30" rows="9"
                                 placeholder="No more data"></textarea>
                           </div>
                        </div>
                        ...
                        <div class="col-12">
                           <div class="form-group">
                              <input class="form-control" name="website" id="website" type="text" placeholder="type Message">
